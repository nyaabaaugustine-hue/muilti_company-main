...
export function AfcftaHero() {
  ...
  return (
    <section id="overview" style={{position:"relative",minHeight:"100vh",overflow:"hidden",display:"flex",alignItems:"center"}}>
      <style>{`
        .afcfta-hero-inner{padding:130px 64px 80px;max-width:760px;}
        .afcfta-hero-stats{display:flex;gap:48px;padding-top:36px;border-top:1px solid rgba(245,158,11,0.20);}
        .afcfta-hero-btns{display:flex;gap:14px;flex-wrap:wrap;margin-bottom:72px;}
        @media(max-width:768px){
          .afcfta-hero-inner{padding:100px 24px 60px;}
          .afcfta-hero-stats{gap:24px;flex-wrap:wrap;}
