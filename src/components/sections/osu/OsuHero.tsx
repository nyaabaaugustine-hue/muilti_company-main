...
export function OsuHero() {
  return (
    <section id="overview" style={{
      ...
      background: "linear-gradient(135deg, #0C1A30 0%, #102032 60%,#142844 100%)",
    }}>
      <div style={{ position:"absolute",inset:0, backgroundImage:"linear-gradient(rgba(59,130,246,0.06) 1px,transparent 1px),linear-gradient(90deg,rgba(59,130,246,0.06) 1px,transparent 1px)", backgroundSize:"64px 64px" }} />
      <div style={{ position:"absolute",top:"-20%",right:"-5%",width:"65%",height:"140%", background:"radial-gradient(ellipse,rgba(59,130,246,0.13) 0%,transparent 60%)", pointerEvents:"none" }} />
      <div style={{ position:"absolute",right:0,top:0,width:"46%",height:"100%",overflow:"hidden" }}>
        <img src="https://res.cloudinary.com/dwsl2ktt2/image/upload/v1777865847/WhatsApp_Image_2026-05-03_at_7.41.12_PM_buzbtt.jpg"
          alt="Osu Digital Hub" style={{ width:"100%",height:"100%",objectFit:"cover",opacity:0.33,filter:"grayscale(10%)" }} />
        <div style={{ position:"absolute",inset:0, background:"linear-gradient(90deg,#0C1A30 0%,rgba(12,26,48,0.1) 60%,rgba(12,26,48,0.5) 100%)" }} />
      </div>
      <div style={{ position:"relative",zIndex:2,padding:"130px 64px 80px",maxWidth:720 }}>
        ...
        <div style={{ display:"flex",gap:14,flexWrap:"wrap",marginBottom:72 }}>
          <a href="#services" style={{ background:"linear-gradient(135deg,#1D4ED8,#3B82F6)",color:"#fff",fontSize:12,fontWeight:700,letterSpacing:"0.08em",textTransform:"uppercase",padding:"14px 32px",borderRadius:2,textDecoration:"none",display:"flex",alignItems:"center",gap:8,boxShadow:"0 8px 32px rgba(59,130,246,0.35)" }}>
            Our Services <ArrowRight size={14} />
          </a>
          <a href="#projects" style={{ background:"transparent",border:"1px solid rgba(59,130,246,0.50)",color:"#3B82F6",fontSize:12,fontWeight:500,letterSpacing:"0.08em",textTransform:"uppercase",padding:"13px 28px",borderRadius:2,textDecoration:"none" }}>
            View Projects
          </a>
        </div>
        <div style={{ display:"flex",gap:48,paddingTop:36,borderTop:"1px solid rgba(59,130,246,0.20)" }}>
