...
export function WomenActivities() {
  ...
  return (
    <section id="activities" style={{ background: "#F5F5F0", padding: "100px 64px" }}>
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: 56, flexWrap: "wrap", gap: 24 }}>
          ...
          <p style={{ fontSize: 13, color: "#666", maxWidth: 340, lineHeight: 1.75, margin: 0 }}>
          ...
          {ACTIVITIES.map((act, i) => (
            ...
            >
              ...
              <div style={{ position: "relative", width: 180, flexShrink: 0, overflow: "hidden" }}>
                <img src={act.img} alt={act.title} style={{ width: "100%", height: "100%", objectFit: "cover", transition: "transform 0.5s", transform: hov === i ? "scale(1.07)" : "scale(1)" }} />
              ...
              <div style={{ padding: "24px 24px 24px 20px", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
                <div>
                  ...
                  <h3 style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: 21, fontWeight: 700, color: "#0A0A0A", marginBottom: 10, lineHeight: 1.25 }}>{act.title}</h3>
                  <p style={{ fontSize: 12.5, color: "#555", lineHeight: 1.75, margin: 0 }}>{act.desc}</p>
                </div>
